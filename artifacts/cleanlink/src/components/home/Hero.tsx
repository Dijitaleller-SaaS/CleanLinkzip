        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-primary/10 text-primary font-medium text-sm mb-6 shadow-sm">
              ...
              Artık 5 şehirde hizmetinizdeyiz
            </div>
            ...
            {/* City Selector */}
            <div className="glass rounded-2xl p-2 max-w-md mx-auto lg:mx-0 flex items-center shadow-lg shadow-primary/5">
              <div className="flex-1 flex items-center px-4">
                <MapPin className="w-5 h-5 text-primary mr-3 flex-shrink-0" />
                <select 
                  className="w-full bg-transparent border-none text-foreground font-medium outline-none cursor-pointer py-3 appearance-none"
                  value={city}
                  onChange={(e) => setCity(e.target.value)}
                  style={{ backgroundImage: 'none' }}
                >
                  <option value="" disabled className="text-gray-400">Bölge Seçiniz</option>
                  {CITIES.map(c => (
          ...
          >
            {/* Background image behind calculator */}
